// Socket.IO server for real-time unread count updates via Redis PubSub.
// Also mounts Ask AI, Archive Assistant, and Briefing streaming handlers
// that relay AI responses from Redis channels to connected clients.
// Generated by CoffeeScript 2.6.1
(function() {
  var archive_assistant, ask_ai, briefing, fs, log, redis, unread_counts, webfeed;
    ...
    io.on('connection', function(socket) {
      ...
      socket.on('subscribe:feeds', (feeds, username) => {
        ...
        return socket.subscribe.on('message', (channel, message) => {
          var event_name, handled, is_ask_ai;
          ...
          if (typeof message.startsWith === "function" ? message.startsWith('briefing:') : void 0) {
          ...
          if (typeof message.startsWith === "function" ? message.startsWith('archive_assistant:') : void 0) {
          ...
          if (typeof message.startsWith === "function" ? message.startsWith('webfeed:') : void 0) {
