...
class Test_Reader(TransactionTestCase):
    ...
    def test_api_feeds(self):
        ...
        self.assertEqual(
            content["folders"], [{"Tech": [1, 4, 5, {"Deep Tech": [6, 7]}]}, 2, 3, 8, 9, {"Blogs": [8, 9]}, 1]
        )
    ...
    def test_delete_feed(self):
        ...
        feeds = json.decode(response.content)
        self.assertEqual(
            feeds["folders"], [2, 3, 8, 9, {"Tech": [1, 4, 5, {"Deep Tech": [6, 7]}]}, {"Blogs": [8, 9]}]
        )
        ...
        feeds = json.decode(response.content)
        self.assertEqual(
            feeds["folders"], [2, 3, 8, 9, {"Tech": [1, 4, 5, {"Deep Tech": [6, 7]}]}, {"Blogs": [8]}]
        )
        ...
        feeds = json.decode(response.content)
        self.assertEqual(
            feeds["folders"], [2, 3, 8, 9, {"Tech": [1, 4, {"Deep Tech": [6, 7]}]}, {"Blogs": [8]}]
        )
    ...
    def test_move_feeds_by_folder(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                644144,
                1187026,
                {"Brainiacs & Opinion": [569, 38, 3581, 183139, 1186180, 15]},
                {
                    "Science & Technology": [
                        731503,
                        140145,
                        ...
                        161,
                        39,
                        {"Hacker": [5985150, 3323431]},
                    ]
                },
                {"Humor": [212379, 3530, 5994357]},
                {"Videos": [3240, 5168]},
            ],
        )
        ...
        response = self.client.post(
            reverse("move-feeds-by-folder-to-folder"),
            {
                "feeds_by_folder": '[\n  [\n    "5994357",\n    "Humor"\n  ],\n  [\n    "3530",\n    "Humor"\n  ]\n]',
        ...
        self.assertEqual(
            ...
            [
                ...
                644144,
                1187026,
                {"Brainiacs & Opinion": [569, 38, 3581, 183139, 1186180, 15, 5994357, 3530]},
                {
                    "Science & Technology": [
                        731503,
                        140145,
