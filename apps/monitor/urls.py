...
urlpatterns = [
    ...
    re_path(r"^media-player?$", MediaPlayer.as_view(), name="media_player"),
    ...
    re_path(r"^webfeed-usage?$", WebFeedUsage.as_view(), name="webfeed_usage"),
]
