...
urlpatterns = [
    ...
    url(r"^classifier/?$", views.set_classifier_notification, name="set-classifier-notification"),
    url(r"^classifiers/?$", views.get_classifier_notifications, name="get-classifier-notifications"),
